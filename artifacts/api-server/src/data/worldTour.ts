...
export const WORLD_TOUR: WorldTourEvent[] = [
  ...
  // Location rotates each season; opponents resolved after regional qualification.
  {
    ...
    prize: 115000,  tier: "World Semi Final",
  },
  {
