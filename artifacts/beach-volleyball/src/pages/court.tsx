...
function PalmTrees() {
  const trees: { pos: [number, number, number]; lx: number; lz: number; h: number }[] = [
    { pos: [ 19.0,  0,  -3.0], lx:  0.08, lz: -0.12, h: 5.8 },
    { pos: [ 20.0,  0,   6.0], lx: -0.05, lz: -0.14, h: 6.2 },
    { pos: [ 18.0,  0,  13.0], lx:  0.10, lz: -0.08, h: 5.5 },
    { pos: [-19.0,  0,  -5.0], lx:  0.06, lz:  0.13, h: 6.0 },
    { pos: [-20.0,  0,   4.5], lx: -0.08, lz:  0.15, h: 5.7 },
    { pos: [-18.0,  0,  12.0], lx:  0.12, lz:  0.09, h: 6.3 },
    { pos: [  6.0,  0,  20.0], lx:  0.15, lz:  0.05, h: 5.6 },
    { pos: [ -6.0,  0,  20.0], lx:  0.10, lz: -0.06, h: 6.1 },
    { pos: [ -9.0,  0, -19.0], lx: -0.12, lz:  0.08, h: 5.9 },
    { pos: [  9.0,  0, -18.5], lx: -0.08, lz: -0.10, h: 5.4 },
    { pos: [ 16.0,  0, -16.0], lx:  0.07, lz: -0.13, h: 6.0 },
    { pos: [-16.0,  0, -15.0], lx: -0.10, lz:  0.11, h: 5.8 },
    { pos: [  2.5,  0,  22.0], lx:  0.09, lz:  0.04, h: 6.4 },
    { pos: [-14.0,  0,  17.0], lx:  0.06, lz: -0.12, h: 5.5 },
    { pos: [ 14.0,  0,  18.0], lx:  0.11, lz: -0.07, h: 6.2 },
    { pos: [-21.0,  0,  -9.0], lx: -0.07, lz:  0.14, h: 5.9 },
    { pos: [  4.0,  0, -21.0], lx: -0.13, lz:  0.06, h: 6.0 },
    // 20 additional trees — all ≥ 19 units from origin, filling perimeter gaps
    { pos: [ 23.0,  0,  10.0], lx:  0.09, lz: -0.11, h: 5.7 },
    { pos: [ 24.0,  0,  -8.0], lx:  0.06, lz: -0.15, h: 6.1 },
    { pos: [ 22.0,  0, -14.0], lx:  0.11, lz: -0.10, h: 5.5 },
    { pos: [ 20.0,  0, -20.0], lx: -0.08, lz: -0.12, h: 6.3 },
    { pos: [-22.0,  0,  10.0], lx: -0.10, lz:  0.09, h: 5.8 },
    { pos: [-24.0,  0,  -8.0], lx:  0.07, lz:  0.13, h: 6.0 },
    { pos: [-22.0,  0, -14.0], lx: -0.09, lz:  0.11, h: 5.6 },
    { pos: [-20.0,  0, -20.0], lx:  0.12, lz:  0.08, h: 6.2 },
    { pos: [  0.0,  0,  25.0], lx:  0.14, lz:  0.04, h: 6.4 },
    { pos: [-12.0,  0,  22.0], lx:  0.08, lz: -0.07, h: 5.9 },
    { pos: [ 12.0,  0,  22.0], lx:  0.11, lz:  0.06, h: 5.6 },
    { pos: [ -3.0,  0, -25.0], lx: -0.13, lz:  0.05, h: 6.1 },
    { pos: [ 14.0,  0, -23.0], lx: -0.09, lz: -0.11, h: 5.7 },
    { pos: [-14.0,  0, -23.0], lx: -0.07, lz:  0.12, h: 6.0 },
    { pos: [ 26.0,  0,   3.0], lx:  0.05, lz: -0.14, h: 5.8 },
    { pos: [-26.0,  0,   1.0], lx: -0.06, lz:  0.15, h: 6.3 },
    { pos: [ 25.0,  0, -15.0], lx:  0.09, lz: -0.13, h: 5.5 },
    { pos: [-25.0,  0, -12.0], lx: -0.11, lz:  0.10, h: 6.0 },
    { pos: [ 18.0,  0, -22.0], lx: -0.10, lz: -0.09, h: 5.9 },
    { pos: [-18.0,  0, -22.0], lx:  0.08, lz:  0.13, h: 6.2 },
  ];
  return (
    <group>
      {trees.map((t, i) => (
