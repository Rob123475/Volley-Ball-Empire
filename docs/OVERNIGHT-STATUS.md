...
| 9 | BUILD — v0.9.2 to C:\build\vbe | DONE | `06be253`, repackaged at `8b34a07` |
| 10 | REPORT | this file | — |
...
`C:\build\vbe\Beach Volleyball Empire Setup 0.9.2.exe` (370,068,772 bytes) and
`C:\build\vbe\win-unpacked\`, from commit `8b34a07` — the branch tip. It was
first built at `06be253` and repackaged after the two follow-up fixes below,
so what is on disk is what is on GitHub. electron-builder 25.1.8,
Electron 32.3.3, x64.
