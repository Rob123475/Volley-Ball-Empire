...
record("I8", "THE ARC COMPLETES", "PARTIAL",
  ["The arc now RUNS: harness/rollover.mjs walks a career through five season",
   "boundaries and on (L-01: a career has no last season; the same suite plays",
   "one career to season 30). What cannot be measured is the second half of the",
   ...
   "",
   "Player vs tier, measured across the first five seasons of a real career:",
...
record("I9", "MONEY STAYS MEANINGFUL", "VIOLATED",
  ["End-of-arc balance $3,100,000 from a career that played no matches: income",
   ...
   "first five seasons have no spending decision left to make.",
   "",
