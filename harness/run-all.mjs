...
console.log("\n########## 3/39  REFERENCE DATA BACKFILL (R-28) ##########");
...
console.log("\n########## 4/39  REFERENCE DATA UPDATE (R-33) ##########");
...
// never seen at all.
console.log("\n########## 5/39  REFERENCE DATA NEW PLAYERS (R-34) ##########");
...
console.log("\n########## 6/39  SAVE FOLDER MOVES WITH THE RENAME (R-23) ##########");
...
console.log("\n########## 9/39  UNITY MATCH-STATE CAREER SCOPING (R-38) ##########");
...
console.log("\n########## 15/39  BOARD SEASON REVIEW (R-53) ##########");
...
console.log("\n########## 16/39  WORLD TOUR COMPETITORS (R-29) ##########");
...
console.log("\n########## 19/39  OLYMPIC QUALIFICATION (R-46) ##########");
...
console.log("\n########## 22/39  EMPTY SQUAD FORFEIT (R-48) ##########");
...
// server.
console.log("\n########## 23/39  INJURIES AND FITNESS (R-50) ##########");
...
console.log("\n########## 25/39  INVENTED CONTENT REMOVED (R-43) ##########");
...
// server.
console.log("\n########## 26/39  DASHBOARD TIER AND BOARD STANDING (R-58) ##########");
...
console.log("\n########## 27/39  RESIGN AND BREAK CONTRACT END THE CAREER (R-60) ##########");
...
console.log("\n########## 30/39  ACADEMY CAP AND WAGES (R-63) ##########");
...
console.log("\n########## 31/39  WIZARD CAREER ECONOMY AND STAFF WAGES (R-67) ##########");
...
console.log("\n########## 32/39  CALENDAR CLOCK TICKS VISIBLY (R-68) ##########");
...
console.log("\n########## 33/39  SOUNDTRACK PLAYLIST AND PLAYER (R-79) ##########");
...
console.log("\n########## 34/39  SEASON PHASE IN THE TOP BAR (R-70) ##########");
...
console.log("\n########## 35/39  CLUB KITS REACH THE 3D COURT (R-73) ##########");
...
console.log("\n########## 36/39  POOL PAIRS' SKIN TONES (R-75) ##########");
...
// Own DB and server.
console.log("\n########## 37/39  WATCHED MATCHES COUNT; HONEST ACHIEVEMENTS (R-77) ##########");
