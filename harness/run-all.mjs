...
console.log("\n########## 3/32  REFERENCE DATA BACKFILL (R-28) ##########");
...
console.log("\n########## 4/32  REFERENCE DATA UPDATE (R-33) ##########");
...
// never seen at all.
console.log("\n########## 5/32  REFERENCE DATA NEW PLAYERS (R-34) ##########");
...
console.log("\n########## 6/32  SAVE FOLDER MOVES WITH THE RENAME (R-23) ##########");
...
console.log("\n########## 9/32  UNITY MATCH-STATE CAREER SCOPING (R-38) ##########");
...
console.log("\n########## 15/32  BOARD SEASON REVIEW (R-53) ##########");
...
console.log("\n########## 16/32  WORLD TOUR COMPETITORS (R-29) ##########");
...
console.log("\n########## 19/32  OLYMPIC QUALIFICATION (R-46) ##########");
...
console.log("\n########## 22/32  EMPTY SQUAD FORFEIT (R-48) ##########");
...
// server.
console.log("\n########## 23/32  INJURIES AND FITNESS (R-50) ##########");
...
console.log("\n########## 25/32  INVENTED CONTENT REMOVED (R-43) ##########");
...
// server.
console.log("\n########## 26/32  DASHBOARD TIER AND BOARD STANDING (R-58) ##########");
...
console.log("\n########## 27/32  RESIGN AND BREAK CONTRACT END THE CAREER (R-60) ##########");
...
console.log("\n########## 30/32  ACADEMY CAP AND WAGES (R-63) ##########");
