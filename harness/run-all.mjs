...
console.log("\n########## 3/37  REFERENCE DATA BACKFILL (R-28) ##########");
...
console.log("\n########## 4/37  REFERENCE DATA UPDATE (R-33) ##########");
...
// never seen at all.
console.log("\n########## 5/37  REFERENCE DATA NEW PLAYERS (R-34) ##########");
...
console.log("\n########## 6/37  SAVE FOLDER MOVES WITH THE RENAME (R-23) ##########");
...
console.log("\n########## 9/37  UNITY MATCH-STATE CAREER SCOPING (R-38) ##########");
...
console.log("\n########## 15/37  BOARD SEASON REVIEW (R-53) ##########");
...
console.log("\n########## 16/37  WORLD TOUR COMPETITORS (R-29) ##########");
...
console.log("\n########## 19/37  OLYMPIC QUALIFICATION (R-46) ##########");
...
console.log("\n########## 22/37  EMPTY SQUAD FORFEIT (R-48) ##########");
...
// server.
console.log("\n########## 23/37  INJURIES AND FITNESS (R-50) ##########");
...
console.log("\n########## 25/37  INVENTED CONTENT REMOVED (R-43) ##########");
...
// server.
console.log("\n########## 26/37  DASHBOARD TIER AND BOARD STANDING (R-58) ##########");
...
console.log("\n########## 27/37  RESIGN AND BREAK CONTRACT END THE CAREER (R-60) ##########");
...
console.log("\n########## 30/37  ACADEMY CAP AND WAGES (R-63) ##########");
...
console.log("\n########## 31/37  WIZARD CAREER ECONOMY AND STAFF WAGES (R-67) ##########");
...
console.log("\n########## 32/37  CALENDAR CLOCK TICKS VISIBLY (R-68) ##########");
...
console.log("\n########## 33/37  SEASON PHASE IN THE TOP BAR (R-70) ##########");
...
console.log("\n########## 34/37  CLUB KITS REACH THE 3D COURT (R-73) ##########");
...
console.log("\n########## 35/37  POOL PAIRS' SKIN TONES (R-75) ##########");
