...
console.log("\n########## 3/48  REFERENCE DATA BACKFILL (R-28) ##########");
...
console.log("\n########## 4/48  REFERENCE DATA UPDATE (R-33) ##########");
...
// never seen at all.
console.log("\n########## 5/48  REFERENCE DATA NEW PLAYERS (R-34) ##########");
...
console.log("\n########## 6/48  SAVE FOLDER MOVES WITH THE RENAME (R-23) ##########");
...
console.log("\n########## 9/48  UNITY MATCH-STATE CAREER SCOPING (R-38) ##########");
...
console.log("\n########## 15/48  BOARD SEASON REVIEW (R-53) ##########");
...
console.log("\n########## 16/48  WORLD TOUR COMPETITORS (R-29) ##########");
...
console.log("\n########## 19/48  OLYMPIC QUALIFICATION (R-46) ##########");
...
console.log("\n########## 22/48  EMPTY SQUAD FORFEIT (R-48) ##########");
...
// server.
console.log("\n########## 23/48  INJURIES AND FITNESS (R-50) ##########");
...
console.log("\n########## 25/48  INVENTED CONTENT REMOVED (R-43) ##########");
...
// server.
console.log("\n########## 26/48  DASHBOARD TIER AND BOARD STANDING (R-58) ##########");
...
console.log("\n########## 27/48  RESIGN AND BREAK CONTRACT END THE CAREER (R-60) ##########");
...
console.log("\n########## 30/48  ACADEMY CAP AND WAGES (R-63) ##########");
...
console.log("\n########## 31/48  WIZARD CAREER ECONOMY AND STAFF WAGES (R-67) ##########");
...
console.log("\n########## 32/48  CALENDAR CLOCK TICKS VISIBLY (R-68) ##########");
...
console.log("\n########## 33/48  SOUNDTRACK PLAYLIST AND PLAYER (R-79) ##########");
...
console.log("\n########## 35/48  RETIREMENT AT FORTY (L-02b) ##########");
...
console.log("\n########## 36/48  YOUTH REBIRTH, 30 SEASONS x 3 REGIONS (L-02c) ##########");
...
console.log("\n########## 37/48  GRADUATE CAP AND TRADING (L-02d) ##########");
...
console.log("\n########## 39/48  ACHIEVEMENTS OVER THE FORK CHANNEL (ACH) ##########");
...
console.log("\n########## 40/48  MONEY MEANS SOMETHING (L-04) ##########");
...
console.log("\n########## 41/48  CLUB SOLD; THE JOB MARKET (L-02e) ##########");
...
console.log("\n########## 42/48  SEASON PHASE IN THE TOP BAR (R-70) ##########");
...
console.log("\n########## 43/48  CLUB KITS REACH THE 3D COURT (R-73) ##########");
...
console.log("\n########## 44/48  POOL PAIRS' SKIN TONES (R-75) ##########");
...
// Own DB and server.
console.log("\n########## 45/48  WATCHED MATCHES COUNT; HONEST ACHIEVEMENTS (R-77) ##########");
...
console.log("\n########## 46/48  EVERY CLUB KEEPS BOOKS (AI CLUB ECONOMY) ##########");
