...
console.log("\n########## 3/27  REFERENCE DATA BACKFILL (R-28) ##########");
...
console.log("\n########## 4/27  REFERENCE DATA UPDATE (R-33) ##########");
...
// never seen at all.
console.log("\n########## 5/27  REFERENCE DATA NEW PLAYERS (R-34) ##########");
...
console.log("\n########## 6/27  SAVE FOLDER MOVES WITH THE RENAME (R-23) ##########");
...
console.log("\n########## 9/27  UNITY MATCH-STATE CAREER SCOPING (R-38) ##########");
...
console.log("\n########## 15/27  BOARD SEASON REVIEW (R-53) ##########");
...
console.log("\n########## 16/27  WORLD TOUR COMPETITORS (R-29) ##########");
...
console.log("\n########## 19/27  OLYMPIC QUALIFICATION (R-46) ##########");
...
console.log("\n########## 22/27  EMPTY SQUAD FORFEIT (R-48) ##########");
...
// server.
console.log("\n########## 23/27  INJURIES AND FITNESS (R-50) ##########");
...
console.log("\n########## 25/27  INVENTED CONTENT REMOVED (R-43) ##########");
