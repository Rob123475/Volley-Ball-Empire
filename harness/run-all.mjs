...
console.log("\n########## 3/43  REFERENCE DATA BACKFILL (R-28) ##########");
...
console.log("\n########## 4/43  REFERENCE DATA UPDATE (R-33) ##########");
...
// never seen at all.
console.log("\n########## 5/43  REFERENCE DATA NEW PLAYERS (R-34) ##########");
...
console.log("\n########## 6/43  SAVE FOLDER MOVES WITH THE RENAME (R-23) ##########");
...
console.log("\n########## 9/43  UNITY MATCH-STATE CAREER SCOPING (R-38) ##########");
...
console.log("\n########## 15/43  BOARD SEASON REVIEW (R-53) ##########");
...
console.log("\n########## 16/43  WORLD TOUR COMPETITORS (R-29) ##########");
...
console.log("\n########## 19/43  OLYMPIC QUALIFICATION (R-46) ##########");
...
console.log("\n########## 22/43  EMPTY SQUAD FORFEIT (R-48) ##########");
...
// server.
console.log("\n########## 23/43  INJURIES AND FITNESS (R-50) ##########");
...
console.log("\n########## 25/43  INVENTED CONTENT REMOVED (R-43) ##########");
...
// server.
console.log("\n########## 26/43  DASHBOARD TIER AND BOARD STANDING (R-58) ##########");
...
console.log("\n########## 27/43  RESIGN AND BREAK CONTRACT END THE CAREER (R-60) ##########");
...
console.log("\n########## 30/43  ACADEMY CAP AND WAGES (R-63) ##########");
...
console.log("\n########## 31/43  WIZARD CAREER ECONOMY AND STAFF WAGES (R-67) ##########");
...
console.log("\n########## 32/43  CALENDAR CLOCK TICKS VISIBLY (R-68) ##########");
...
console.log("\n########## 33/43  SOUNDTRACK PLAYLIST AND PLAYER (R-79) ##########");
...
console.log("\n########## 35/43  RETIREMENT AT FORTY (L-02b) ##########");
...
console.log("\n########## 36/43  YOUTH REBIRTH, 30 SEASONS x 3 REGIONS (L-02c) ##########");
...
console.log("\n########## 37/43  GRADUATE CAP AND TRADING (L-02d) ##########");
...
console.log("\n########## 38/43  SEASON PHASE IN THE TOP BAR (R-70) ##########");
...
console.log("\n########## 39/43  CLUB KITS REACH THE 3D COURT (R-73) ##########");
...
console.log("\n########## 40/43  POOL PAIRS' SKIN TONES (R-75) ##########");
...
// Own DB and server.
console.log("\n########## 41/43  WATCHED MATCHES COUNT; HONEST ACHIEVEMENTS (R-77) ##########");
