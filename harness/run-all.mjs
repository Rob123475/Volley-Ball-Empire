...
console.log("\n########## 3/41  REFERENCE DATA BACKFILL (R-28) ##########");
...
console.log("\n########## 4/41  REFERENCE DATA UPDATE (R-33) ##########");
...
// never seen at all.
console.log("\n########## 5/41  REFERENCE DATA NEW PLAYERS (R-34) ##########");
...
console.log("\n########## 6/41  SAVE FOLDER MOVES WITH THE RENAME (R-23) ##########");
...
console.log("\n########## 9/41  UNITY MATCH-STATE CAREER SCOPING (R-38) ##########");
...
console.log("\n########## 15/41  BOARD SEASON REVIEW (R-53) ##########");
...
console.log("\n########## 16/41  WORLD TOUR COMPETITORS (R-29) ##########");
...
console.log("\n########## 19/41  OLYMPIC QUALIFICATION (R-46) ##########");
...
console.log("\n########## 22/41  EMPTY SQUAD FORFEIT (R-48) ##########");
...
// server.
console.log("\n########## 23/41  INJURIES AND FITNESS (R-50) ##########");
...
console.log("\n########## 25/41  INVENTED CONTENT REMOVED (R-43) ##########");
...
// server.
console.log("\n########## 26/41  DASHBOARD TIER AND BOARD STANDING (R-58) ##########");
...
console.log("\n########## 27/41  RESIGN AND BREAK CONTRACT END THE CAREER (R-60) ##########");
...
console.log("\n########## 30/41  ACADEMY CAP AND WAGES (R-63) ##########");
...
console.log("\n########## 31/41  WIZARD CAREER ECONOMY AND STAFF WAGES (R-67) ##########");
...
console.log("\n########## 32/41  CALENDAR CLOCK TICKS VISIBLY (R-68) ##########");
...
console.log("\n########## 33/41  SOUNDTRACK PLAYLIST AND PLAYER (R-79) ##########");
...
console.log("\n########## 35/41  RETIREMENT AT FORTY (L-02b) ##########");
...
console.log("\n########## 36/41  SEASON PHASE IN THE TOP BAR (R-70) ##########");
...
console.log("\n########## 37/41  CLUB KITS REACH THE 3D COURT (R-73) ##########");
...
console.log("\n########## 38/41  POOL PAIRS' SKIN TONES (R-75) ##########");
...
// Own DB and server.
console.log("\n########## 39/41  WATCHED MATCHES COUNT; HONEST ACHIEVEMENTS (R-77) ##########");
