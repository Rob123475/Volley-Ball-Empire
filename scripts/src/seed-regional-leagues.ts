...
const POOL: Record<string, TeamDef[]> = {
  "Europe": [
    ...
    { stableId: "EUR_02", teamName: "Barcelona Playa Elites",   isActiveInLeague: true,  poolRanking: 2,  rating: 85, form: 68, players: [{ name: "María Alonso",         nationality: "Spain",     age: 28, speed: 82, power: 78, defense: 84, serve: 84, block: 80, stamina: 80 }, { name: "Carmen Ruiz",        nationality: "Spain",     age: 26, speed: 86, power: 76, defense: 86, serve: 80, block: 78, stamina: 84 }] },
    { stableId: "EUR_03", teamName: "Paris Sables Royales",     isActiveInLeague: true,  poolRanking: 3,  rating: 82, form: 64, players: [{ name: "Élise Fontaine",       nationality: "France",      age: 26, speed: 80, power: 72, defense: 84, serve: 80, block: 76, stamina: 78 }, { name: "Céline Moreau",      nationality: "France",      age: 24, speed: 84, power: 70, defense: 82, serve: 78, block: 74, stamina: 80 }] },
    { stableId: "EUR_04", teamName: "Rome Beach Gladiators",    isActiveInLeague: true,  poolRanking: 4,  rating: 79, form: 60, players: [{ name: "Giulia Ricci",         nationality: "Italy",     age: 29, speed: 78, power: 76, defense: 80, serve: 78, block: 80, stamina: 76 }, { name: "Valentina Bianchi",  nationality: "Italy",     age: 27, speed: 80, power: 74, defense: 78, serve: 76, block: 78, stamina: 78 }] },
    ...
    { stableId: "EUR_07", teamName: "Warsaw Vistula Waves",     isActiveInLeague: false, poolRanking: 7,  rating: 70, form: 48, players: [{ name: "Agnieszka Kowal",       nationality: "Poland",      age: 27, speed: 74, power: 66, defense: 72, serve: 70, block: 70, stamina: 72 }, { name: "Marta Wiśniewska",   nationality: "Poland",      age: 25, speed: 72, power: 64, defense: 70, serve: 68, block: 68, stamina: 70 }] },
  ...
  "Asia": [
    ...
    { stableId: "ASI_04", teamName: "Bangkok Palm Beach Stars",  isActiveInLeague: true,  poolRanking: 4,  rating: 78, form: 58, players: [{ name: "Nisa Suwannaphat",     nationality: "Thailand",        age: 26, speed: 82, power: 70, defense: 76, serve: 76, block: 74, stamina: 78 }, { name: "Pimchanok Meesuk",   nationality: "Thailand",        age: 24, speed: 80, power: 68, defense: 74, serve: 74, block: 72, stamina: 76 }] },
    { stableId: "ASI_05", teamName: "Mumbai Coastal Warriors",   isActiveInLeague: true,  poolRanking: 5,  rating: 75, form: 54, players: [{ name: "Priya Sharma",         nationality: "India",      age: 27, speed: 78, power: 66, defense: 74, serve: 72, block: 70, stamina: 76 }, { name: "Ananya Nair",        nationality: "India",      age: 25, speed: 76, power: 64, defense: 72, serve: 70, block: 68, stamina: 74 }] },
  ...
  "North America": [
    { stableId: "NAM_01", teamName: "LA Beach Legends",           isActiveInLeague: true,  poolRanking: 1,  rating: 90, form: 74, players: [{ name: "Ashley Carter",       nationality: "USA",    age: 28, speed: 88, power: 84, defense: 88, serve: 88, block: 86, stamina: 84 }, { name: "Taylor Brooks",      nationality: "USA",    age: 26, speed: 90, power: 80, defense: 86, serve: 86, block: 82, stamina: 86 }] },
    { stableId: "NAM_02", teamName: "Miami Shoreline Queens",     isActiveInLeague: true,  poolRanking: 2,  rating: 87, form: 70, players: [{ name: "Destiny Rivera",      nationality: "USA",    age: 27, speed: 86, power: 82, defense: 84, serve: 86, block: 84, stamina: 82 }, { name: "Jasmine Washington", nationality: "USA",    age: 25, speed: 88, power: 80, defense: 82, serve: 84, block: 82, stamina: 84 }] },
    ...
    { stableId: "NAM_05", teamName: "Honolulu Aloha Warriors",    isActiveInLeague: true,  poolRanking: 5,  rating: 78, form: 58, players: [{ name: "Kalani Akana",        nationality: "USA",    age: 26, speed: 84, power: 70, defense: 76, serve: 76, block: 74, stamina: 80 }, { name: "Lani Kealoha",       nationality: "USA",    age: 24, speed: 82, power: 68, defense: 74, serve: 74, block: 72, stamina: 78 }] },
    { stableId: "NAM_06", teamName: "Vancouver Pacific Orcas",    isActiveInLeague: true,  poolRanking: 6,  rating: 75, form: 54, players: [{ name: "Brittany MacLeod",    nationality: "Canada",    age: 27, speed: 80, power: 70, defense: 74, serve: 74, block: 72, stamina: 76 }, { name: "Cassandra Tremblay", nationality: "Canada",    age: 25, speed: 78, power: 68, defense: 72, serve: 72, block: 70, stamina: 74 }] },
    { stableId: "NAM_07", teamName: "Myrtle Beach Sunblazers",    isActiveInLeague: false, poolRanking: 7,  rating: 72, form: 50, players: [{ name: "Madison Hughes",      nationality: "USA",    age: 26, speed: 78, power: 66, defense: 72, serve: 70, block: 70, stamina: 74 }, { name: "Brooke Simmons",     nationality: "USA",    age: 24, speed: 76, power: 64, defense: 70, serve: 68, block: 68, stamina: 72 }] },
  ...
  "South America": [
    { stableId: "SAM_01", teamName: "Rio Copacabana Queens",      isActiveInLeague: true,  poolRanking: 1,  rating: 92, form: 76, players: [{ name: "Fernanda Silva",       nationality: "Brazil",   age: 28, speed: 90, power: 88, defense: 90, serve: 92, block: 88, stamina: 86 }, { name: "Beatriz Costa",      nationality: "Brazil",   age: 26, speed: 92, power: 84, defense: 88, serve: 90, block: 86, stamina: 88 }] },
    { stableId: "SAM_02", teamName: "São Paulo Beach Warriors",   isActiveInLeague: true,  poolRanking: 2,  rating: 89, form: 72, players: [{ name: "Carolina Souza",       nationality: "Brazil",   age: 27, speed: 88, power: 86, defense: 86, serve: 88, block: 86, stamina: 84 }, { name: "Amanda Lima",        nationality: "Brazil",   age: 25, speed: 86, power: 84, defense: 84, serve: 86, block: 84, stamina: 82 }] },
  ...
  "Africa and Middle East": [
    ...
    { stableId: "AFM_02", teamName: "Cairo Desert Eagles",         isActiveInLeague: true,  poolRanking: 2,  rating: 80, form: 62, players: [{ name: "Fatima Al-Rashid",    nationality: "Egypt",    age: 28, speed: 80, power: 76, defense: 78, serve: 78, block: 76, stamina: 78 }, { name: "Nour Ibrahim",       nationality: "Egypt",    age: 26, speed: 82, power: 72, defense: 76, serve: 76, block: 74, stamina: 80 }] },
    { stableId: "AFM_03", teamName: "Durban Indian Ocean Tides",   isActiveInLeague: true,  poolRanking: 3,  rating: 77, form: 58, players: [{ name: "Lindiwe Dlamini",     nationality: "South Africa",age:27, speed: 80, power: 72, defense: 76, serve: 74, block: 76, stamina: 78 }, { name: "Thandi Nkosi",       nationality: "South Africa",age:25, speed: 78, power: 70, defense: 74, serve: 72, block: 74, stamina: 76 }] },
  ...
  "Australia and Pacific Islands": [
    { stableId: "AUS_01", teamName: "Bondi Beach Legends",         isActiveInLeague: true,  poolRanking: 1,  rating: 86, form: 70, players: [{ name: "Scarlett Thompson",   nationality: "Australia",  age: 27, speed: 86, power: 82, defense: 84, serve: 84, block: 84, stamina: 82 }, { name: "Ruby Walker",        nationality: "Australia",  age: 25, speed: 84, power: 78, defense: 82, serve: 82, block: 80, stamina: 84 }] },
    { stableId: "AUS_02", teamName: "Gold Coast Thunderbirds",     isActiveInLeague: true,  poolRanking: 2,  rating: 83, form: 66, players: [{ name: "Chloe Harrison",       nationality: "Australia",  age: 28, speed: 84, power: 80, defense: 80, serve: 82, block: 80, stamina: 80 }, { name: "Lily Mitchell",      nationality: "Australia",  age: 26, speed: 82, power: 76, defense: 78, serve: 80, block: 78, stamina: 82 }] },
    { stableId: "AUS_03", teamName: "Auckland Pacific Diamonds",   isActiveInLeague: true,  poolRanking: 3,  rating: 80, form: 62, players: [{ name: "Aroha Tane",           nationality: "New Zealand",age:27, speed: 82, power: 74, defense: 78, serve: 78, block: 76, stamina: 80 }, { name: "Mia Patel",          nationality: "New Zealand",age:25, speed: 80, power: 72, defense: 76, serve: 76, block: 74, stamina: 78 }] },
